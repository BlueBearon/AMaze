...
import edu.wm.cs.cs301.amazebychasepacker.generation.BSPLeaf;
import edu.wm.cs.cs301.amazebychasepacker.generation.BSPNode;
import edu.wm.cs.cs301.amazebychasepacker.generation.Floorplan;
import edu.wm.cs.cs301.amazebychasepacker.generation.Wall;
...
public class FirstPersonView {
	 ...
	 * @param panel TODO
	 */
	private void drawBackground(float percentToExit, MazePanel panel) {
		...
		/* OLD CODE
		graphics.setColor(panel.getBackgroundColor(percentToExit, true));
		graphics.fillRect(0, 0, viewWidth, viewHeight/2);
		graphics.setColor(panel.getBackgroundColor(percentToExit, false));
	 ...
	 * @param panel TODO
	 */
	private void drawWall(Wall wall, MazePanel panel) {
