...
import edu.wm.cs.cs301.amazebychasepacker.gui.P5Panel21.P5RenderingHints;
...
public class CompassRose {
	...
	private static final int greenWM = -15640768;//RGB Value
	private static final int goldWM = -7246015;
    ...
    public void paintComponent(MazePanel panel) {
        ...
        */
        ...
        drawArms(armLength, armWidth, panel);
        drawBorderCircle(width, panel); // note: not currently visible due to color settings
        drawDirectionMarker(width, panel);
    }
     ...
     */
	private void drawArms(final int length, final int width, MazePanel panel) {
        ...
        // draw each arm
        drawArmNorth(length, width, x, y, panel);
        drawArmEast(length, width, x, y, panel);
        drawArmSouth(length, width, x, y, panel);
        drawArmWest(length, width, x, y, panel);
	}
	 ...
	 * @param panel TODO
	 */
	private void drawArmWest(int length, int width, int[] x, int[] y, MazePanel panel) {
	 ...
	 * @param panel TODO
	 */
	private void drawArmEast(int length, int width, int[] x, int[] y, MazePanel panel) {
	 ...
	 * @param panel TODO
	 */
	private void drawArmSouth(int length, int width, int[] x, int[] y, MazePanel panel) {
		// x[0] and y[0] are already set to the coordinates of the center point
		// set coordinates for 2nd and 3rd point and draw filled triangle
		x[1] = centerX;
        y[1] = centerY + length;
	 ...
	 * @param panel TODO
	 */
	private void drawArmNorth(int length, int width, int[] x, int[] y, MazePanel panel) {
	 ...
	 * @param panel TODO
	 */
	private void drawBorderCircle(int width, MazePanel panel) {
	 ...
	 * @param panel TODO
	 */
	private void drawDirectionMarker(int width, MazePanel panel) {
	 ...
	 * @param panel TODO
	 */
    private void drawMarker(float x, float y, String str, MazePanel panel) {
