...
import edu.wm.cs.cs301.amazebychasepacker.gui.MazeFileWriter;
import edu.wm.cs.cs301.amazebychasepacker.gui.P5Panel21;
...
public class Wall {
    ...
    private int createColor(final int distance, final int cc) 
    {
         ...
         final int Extension = getExtensionX();
         
         return P5Panel21.getWallColor(distance, cc, Extension);
    }
